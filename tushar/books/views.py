...
API_KEY = 'AIzaSyBgyzUJ8MpRYXSz-UEm_lLc-9xESFN5KHE'
class IndexView(TemplateView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return render(request, 'books/search.html', {'b': b})


class InventoryView(ListView):
    model = Books
    template_name = 'books/inventory.html'
...
class BooksUpdate(TemplateView):
    ...
    def post(self, request, ID):
        ...
        if updateform.is_valid():
            ...
            q.save()
        books = Books.objects.all()
        return render(request, 'books/inventory', {'books': books})
...
class BooksAdd(TemplateView):
    def get(self, request):
        addform = AddForm
        return render(request, 'books/add.html', {'form': addform})
    ...
    def post(self, request):
        ...
        q = Books(book_name=my_json['volumeInfo']['title'], ID=temp_key, preview_link='p_link',
